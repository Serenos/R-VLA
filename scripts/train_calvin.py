...
def train(cfg: TrainConfig) -> None:
    ...
    from prismatic.vla.datasets import IterableDiskCalvinDataset
    from prismatic.vla.action_tokenizer import ActionTokenizer
    tokenizer = vla.llm_backbone.get_tokenizer()
    action_tokenizer = ActionTokenizer(tokenizer)

    class CalvinPromptBuilder():
    ...
    vla_dataset = IterableDiskCalvinDataset(
        datasets_dir=cfg.data_root_dir / "training",
        window_size=cfg.future_action_window_size + 1, # Number of frames to load
        action_chunking_size=cfg.future_action_window_size + 1,
        ...
        prompt_builder_fn = CalvinPromptBuilder,
        imagenet_norm=True,
    )
