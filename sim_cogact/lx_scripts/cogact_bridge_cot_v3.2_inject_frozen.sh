...
"/home/lixiang10/workspace/CogACT/CogACT/cot_chekpoint/bridge_ditb_cot_v3.2_plan+position_vlm_loss0.1_inject--image_aug/checkpoints/step-020000-epoch-02-loss=0.0416.pt"

)

used_env_idx=(0,1,2,3)
gpu_ids=(0)
#gpu_ids=(4 5 6 7)
action_model_type=DiT-B

eval_note="eval_cotv3.2_gripper_w_eos_frozen12"
