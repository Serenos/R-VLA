...
class DiT(nn.Module):
    ...
    def __init__(
        ...
        conditions_shape = (1, 1 + num_extra_token, token_size)
        ...
        self.positional_embedding = nn.Parameter(
                scale * torch.randn(future_action_window_size + past_action_window_size + 2 + num_extra_token, hidden_size))
    ...
    def forward(self, x, t, z):
        ...
        return x[:, 1 + self.num_extra_token:, :]     # (N, T, C)
